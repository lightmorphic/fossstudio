...
# The values a person must replace. They are drawn in the accent colour so
# the eye lands on them before it reads anything else.
CHANGE_ME = {"DOMAIN", "PUBLIC_IP", "HOST_PASSWORD", "SESSION_SECRET", "TURN_SECRET"}
